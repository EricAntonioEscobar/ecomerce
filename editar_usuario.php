...
<div class="direccion">
    <form action="procesar_direccion.php?correo=<?php echo $correo;?>" method="POST">
   <div class="input_calle"><input type="text" value="<?php echo $calle?>" name="calle"></div>
   <div><input type="text" value="<?php echo $colonia?>" name="colonia"></div>
   <div><input type="text" value="<?php echo $municipio?>" name="municipio"></div>
   <div><input type="text" value="<?php echo $estado?>" name="estado"></div>
   <div><input type="text" value="<?php echo $cp?>" name="cp"></div>
   <div><input type="text" value="<?php echo $numero?>" name="numero"></div>
