...
if($consultaBD->num_rows>=1){
	...
	while($fila=$consultaBD->fetch_array(MYSQLI_ASSOC)){
		echo "<tr>
		<td><a style='text-decoration: none; color: black; font-family: Roboto, Arial, sans-serif; font-weight: bold; font-size: 13px;' href='articulo.php?id=".$fila['id']."'>".$fila['nombre']."</a></td>	
		</tr>";
	}
	echo "</tbody>
	</table>";
